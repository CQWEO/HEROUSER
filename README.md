...
local ESP_Other = {Rooms_Locker_Fridge={"Locker Fridge",7.5},RoomsDoor_Entrance={"Room",5},ChestBoxLocked={"Chest Locked",8.5},ChestBox={"Chest",8.5},Rooms_Locker={"Locker",7.5},Door={"Door",5},LeverForGate={"Lever",3},GoldPile={"Gold",0.5},Bandage={"Bandage",0.5}}
